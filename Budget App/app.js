    ...
    return {
        ...
        addListItem: function(obj, type) {
            ...
            if(type === 'inc') {
                ...
                class="item__value">%value%</div><div class="item__delete"><button class="item__delete--btn"><i 
                ...
                class="item__delete--btn"><i class="ion-ios-close-outline">
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    var setupEventListeners = function() {  
        ...
        document.querySelector(DOM.conatainer).addEventListener('click', ctrlDeleteItem);
